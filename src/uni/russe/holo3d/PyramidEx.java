...
public class PyramidEx extends Activity {
	GLSurfaceView view;
	GLSurfaceView viewR;
	GLSurfaceView viewG;
	GLSurfaceView viewB;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		view.setRenderer(new OpenGLRendererPyramid());

		viewR = new GLSurfaceView(this);
		viewR.setRenderer(new OpenGLRendererPyramidRed());

		viewG = new GLSurfaceView(this);
		viewG.setRenderer(new OpenGLRendererPyramidGreen());

		viewB = new GLSurfaceView(this);
		viewB.setRenderer(new OpenGLRendererPyramidBlue());

		viewC = new GLSurfaceView(this);
		viewC.setRenderer(new OpenGLRendererPyramidCyan());

		viewM = new GLSurfaceView(this);
		viewM.setRenderer(new OpenGLRendererPyramidMagenta());

		viewY = new GLSurfaceView(this);
		viewY.setRenderer(new OpenGLRendererPyramidYellow());
