...
public class OpenGLRendererPyramidMagenta implements Renderer {
	...
	public void onDrawFrame(GL10 gl) {
		...
		gl.glLoadIdentity();
		gl.glLineWidth(1.5f);
		gl.glColor4f(1.0f, 0.0f, 1.0f, 1.0f);// magenta
		// top
		gl.glTranslatef(0.0f, 2.5f, -10.0f);
		gl.glRotatef(-mPyramidRotation, 0.0f, 1.0f, 0.0f);
		mPyramid.draw(gl);
		gl.glLoadIdentity();
