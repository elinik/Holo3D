...
public class Objects extends Activity implements OnClickListener {
	...
	public void onClick(View view) {
		...
		if (view.equals(cubeButton)) {
			Intent i = new Intent(this, CubeEx.class);
			startActivity(i);
		}
		if (view.equals(coneButton)) {
			Intent i = new Intent(this, ConeEx.class);
			startActivity(i);
		}
		if (view.equals(cylinderButton)) {
			Intent i = new Intent(this, CylinderEx.class);
			startActivity(i);
		}
		if (view.equals(sphereButton)) {
			Intent i = new Intent(this, SphereEx.class);
			startActivity(i);
		}
		if (view.equals(pyramidButton)) {
			Intent i = new Intent(this, PyramidEx.class);
			startActivity(i);
		}
	}
