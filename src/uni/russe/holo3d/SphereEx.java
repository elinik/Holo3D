...
public class SphereEx extends Activity {
	GLSurfaceView view;
	GLSurfaceView viewR;
	GLSurfaceView viewG;
	GLSurfaceView viewB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		view.setRenderer(new OpenGLRendererSphere());

		viewR = new GLSurfaceView(this);
		viewR.setRenderer(new OpenGLRendererSphereRed());

		viewG = new GLSurfaceView(this);
		viewG.setRenderer(new OpenGLRendererSphereGreen());

		viewB = new GLSurfaceView(this);
		viewB.setRenderer(new OpenGLRendererSphereBlue());

		viewC = new GLSurfaceView(this);
		viewC.setRenderer(new OpenGLRendererSphereCyan());

		viewM = new GLSurfaceView(this);
		viewM.setRenderer(new OpenGLRendererSphereMagenta());

		viewY = new GLSurfaceView(this);
		viewY.setRenderer(new OpenGLRendererSphereYellow());
