...
public class CylinderEx extends Activity {
	GLSurfaceView view;
	GLSurfaceView viewR;
	GLSurfaceView viewG;
	GLSurfaceView viewB;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		view.setRenderer(new OpenGLRendererCylinder());

		viewR = new GLSurfaceView(this);
		viewR.setRenderer(new OpenGLRendererCylinderRed());

		viewG = new GLSurfaceView(this);
		viewG.setRenderer(new OpenGLRendererCylinderGreen());

		viewB = new GLSurfaceView(this);
		viewB.setRenderer(new OpenGLRendererCylinderBlue());

		viewC = new GLSurfaceView(this);
		viewC.setRenderer(new OpenGLRendererCylinderCyan());

		viewM = new GLSurfaceView(this);
		viewM.setRenderer(new OpenGLRendererCylinderMagenta());

		viewY = new GLSurfaceView(this);
		viewY.setRenderer(new OpenGLRendererCylinderYellow());
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.color:
			...
			return true;
		case R.id.object:
			Intent i = new Intent(this, Objects.class);
			startActivity(i);
			return true;
		default:
	...
	private void showDialogColor() {
		...
		final CharSequence[] choiceList = { "White", "Red", "Green", "Blue",
				"Cyan", "Magenta", "Yellow" };
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						if (choiceList[which] == choiceList[0]) {
							...
							Toast.makeText(getApplicationContext(),
									"Select " + color, Toast.LENGTH_SHORT)
									.show();
						}
